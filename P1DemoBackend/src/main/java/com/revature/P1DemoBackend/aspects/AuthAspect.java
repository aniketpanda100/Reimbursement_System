...
public class AuthAspect {
    ...
    @Before("within(com.revature.P1DemoBackend.controllers.*)" +
            "&& !within(com.revature.P1DemoBackend.controllers.AuthController)")
    ...
    @Order(2)
    @Before("@annotation(com.revature.P1DemoBackend.aspects.ManagerOnly)")
    public void checkManager(){
        ...
        if(!role.equals("manager")){
            throw new IllegalArgumentException("User must be an manager to do this!");
        }
