...
import com.revature.P1DemoBackend.models.DTOs.LoginDTO;
...
@CrossOrigin(value = "http://localhost:5173", allowCredentials = "true")//This annotation will allow requests from anywhere (like our React app)
